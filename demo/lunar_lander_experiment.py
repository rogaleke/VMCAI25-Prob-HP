...
def run_profile_lander(file, p1_count, p2_count, p3_count, p4_count, split_method='rand_split_single', split_ratio = 0.6, skip_concrete=False):
...
if __name__ == "__main__":
    # Example usage:
    dtmc_path = r'environments\lunar_lander\dtmcs\time10_1.csv'
    run_profile_lander(dtmc_path, 2, 2, 2, 2, split_method='rand_split_single', split_ratio=0.6, skip_concrete=False)